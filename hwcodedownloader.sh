...
wget -O - https://www.gov.uk/highway-code/introduction/print | hxclean | xml2asc | hxselect main | sed -e 's/<main/<section/g' -e 's/<\/main/<\/section/g' -e 's/<aside/<aside class=\"exclude\"/g' | hxprune > downloadedhwcode.html
